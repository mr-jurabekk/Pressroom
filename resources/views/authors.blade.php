                        ...
                        <div class="row">
                            <ul class="blog column column_1_2">
                                ...
                                <li class="post">
                                    ...
                                    <h2 class="with_number">
                                        <a href="index4e1c.html?page=post_small_image" title="High Altitudes May Aid Weight Control">High Altitudes May Aid Weight Control</a>
                                        <a class="comments_number" href="index4e1c.html?page=post_small_image#comments_list" title="2 comments">2<span class="arrow_comments"></span></a>
                                    </h2>
                                    <ul class="post_details">
                            ...
                            <ul class="blog column column_1_2">
                                ...
                                <li class="post">
                                    ...
                                    <h2 class="with_number">
                                        <a href="indexb2ff.html?page=post_video" title="Struggling Nuremberg Sack Coach Verbeek">Struggling Nuremberg Sack Coach Verbeek</a>
                ...
                <div class="column column_1_3">
                    ...
                    <div class="vertical_carousel_container clearfix">
                        <ul class="blog small vertical_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
                            ...
                            <li class="post">
                                <a href="index4e1c.html?page=post_small_image" title="Syrian Civilians Trapped For Months Continue To Be Evacuated">
                                    <img src='images/samples/100x100/image_12.jpg' alt='img'>
                                </a>
                                <div class="post_content">
                                    <h5>
                                        <a href="index4e1c.html?page=post_small_image" title="Syrian Civilians Trapped For Months Continue To Be Evacuated">Syrian Civilians Trapped For Months Continue To Be Evacuated</a>
                                    </h5>
                                    <ul class="post_details simple">
                                        <li class="category"><a href="index7855.html?page=category&amp;cat=world" title="WORLD">WORLD</a></li>
                                        <li class="date">
