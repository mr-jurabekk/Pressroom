        ...
        <div class="page_header clearfix page_margin_top">
            ...
            <div class="page_header_right">
                <ul class="bread_crumb">
                    ...
                    <li>
                        <a title="Authors" href="indexde65.html?page=authors">
                            Authors
                        </a>
                    </li>
                    <li class="separator icon_small_arrow right_gray">
                        ...
                        <ul class="authors_list rating">
                            <li class="author clearfix">
                                ...
                                <div class="content">
                                    ...
                                    <h6>EDITOR</h6>
                                    <h2>Debora Hilton</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In quis consectetur lectus. Pellentesque
                                        consectetur augue eget lacus tincidunt, tincidunt venenatis nunc convallis. Cras at nunc non est
                                        lobortis laoreet.</p>
                        ...
                        <div class="row">
                            <ul class="blog column column_1_2">
                                <li class="post">
                                    ...
                                    <p>Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios
                                ...
                                <li class="post">
                                    <a href="index4e1c.html?page=post_small_image" title="High Altitudes May Aid Weight Control">
                                        <img src='images/samples/330x242/image_02.jpg' alt='img'>
                                    </a>
                                    <h2 class="with_number">
                                        <a href="index4e1c.html?page=post_small_image" title="High Altitudes May Aid Weight Control">High
                                            Altitudes May Aid Weight Control</a>
                                        <a class="comments_number" href="index4e1c.html?page=post_small_image#comments_list"
                                    ...
                                    <p>Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios
                                        dapibus integer an nulla augue pharetra cursus.</p>
                                    <a class="read_more" href="index4e1c.html?page=post_small_image" title="Read more"><span
                                            class="arrow"></span><span>READ MORE</span></a>
                                </li>
                            </ul>
                            <ul class="blog column column_1_2">
                                <li class="post">
                                    ...
                                    <h2 class="with_number">
                                        ...
                                        <a class="comments_number" href="index4b64.html?page=post_quote#comments_list"
                                           title="2 comments">2<span class="arrow_comments"></span></a>
                                    </h2>
                                    <ul class="post_details">
                                    ...
                                    <p>Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios
                                        dapibus integer an nulla augue pharetra cursus.</p>
                                    <a class="read_more" href="index4b64.html?page=post_quote" title="Read more"><span
                                            class="arrow"></span><span>READ MORE</span></a>
                                </li>
                                <li class="post">
                                    <a href="indexb2ff.html?page=post_video" title="Struggling Nuremberg Sack Coach Verbeek">
                                    ...
                                    <h2 class="with_number">
                                        ...
                                        <a class="comments_number" href="indexb2ff.html?page=post_video#comments_list"
                                           title="2 comments">2<span class="arrow_comments"></span></a>
                                    </h2>
                                    <ul class="post_details">
                                    ...
                                    <p>Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios
                                        dapibus integer an nulla augue pharetra cursus.</p>
                                    <a class="read_more" href="indexb2ff.html?page=post_video" title="Read more"><span
                                            class="arrow"></span><span>READ MORE</span></a>
                                </li>
                            </ul>
                        </div>
