        ...
        <div class="page_layout clearfix">
                ...
                <div class="column_1_1">
                    ...
                    <div class="horizontal_carousel_container page_margin_top">
                        <ul class="horizontal_carousel autoplay-1 scroll-1 visible-4 navigation-1 easing-easeInOutQuint duration-750">
                            <li class="author">
                                <a href="index27b5.html?page=author" title="Debora Hilton">
                                    <img src='images/samples/Team_330x242/image_01.jpg' alt='img'>
                                </a>
                                <h6>EDITOR</h6>
                                <h4><a href="index27b5.html?page=author" title="Debora Hilton">Debora Hilton</a></h4>
                            ...
                            <li class="author">
                                <a href="index27b5.html?page=author" title="Anna Shubina">
                                    <img src='images/samples/Team_330x242/image_02.jpg' alt='img'>
                                </a>
                                <h6>EDITOR</h6>
                                <h4><a href="index27b5.html?page=author" title="Anna Shubina">Anna Shubina</a></h4>
                                <p>Maecenas novum mauris elementum est morbi interdum at ague cursus elite imperdiet libero. Proin an odios dapibus integer.</p>
                                <ul class="social_icons margin_top_10 clearfix">
                                    <li>
                                        <a target="_blank" title="" href="https://facebook.com/QuanticaLabs" class="social_icon facebook">
                            ...
                            <li class="author">
                                <a href="index27b5.html?page=author" title="Lian Holden">
                                    <img src='images/samples/Team_330x242/image_03.jpg' alt='img'>
                                </a>
                                <h6>PUBLISHER</h6>
                                <h4><a href="index27b5.html?page=author" title="Lian Holden">Lian Holden</a></h4>
                                <p>Maecenas novum mauris elementum est morbi interdum at ague cursus elite imperdiet libero. Proin an odios dapibus integer.</p>
                                <ul class="social_icons margin_top_10 clearfix">
                                    <li>
                                        <a target="_blank" title="" href="https://facebook.com/QuanticaLabs" class="social_icon facebook">
                            ...
                            <li class="author">
                                <a href="index27b5.html?page=author" title="Heather Dale">
                                    <img src='images/samples/Team_330x242/image_04.jpg' alt='img'>
                                </a>
                                <h6>ILLUSTRATOR</h6>
                                <h4><a href="index27b5.html?page=author" title="Heather Dale">Heather Dale</a></h4>
                                <p>Maecenas novum mauris elementum est morbi interdum at ague cursus elite imperdiet libero. Proin an odios dapibus integer.</p>
                                <ul class="social_icons margin_top_10 clearfix">
                                    <li>
                                        <a target="_blank" title="" href="https://facebook.com/QuanticaLabs" class="social_icon facebook">
                            ...
                            <li class="author">
                                <a href="index27b5.html?page=author" title="Mary Doe">
                                    <img src='images/samples/Team_330x242/image_05.jpg' alt='img'>
                                </a>
                                <h6>EDITOR</h6>
                                <h4><a href="index27b5.html?page=author" title="Mary Doe">Mary Doe</a></h4>
                                <p>Maecenas novum mauris elementum est morbi interdum at ague cursus elite imperdiet libero. Proin an odios dapibus integer.</p>
                                <ul class="social_icons margin_top_10 clearfix">
                                    <li>
                                        <a target="_blank" title="" href="https://facebook.com/QuanticaLabs" class="social_icon facebook">
            ...
            <div class="row page_margin_top_section">
                ...
                <div class="column column_1_2">
                    ...
                    <ul class="blog small">
                        <li class="post">
                            <a href="indexb878.html?page=post" title="Engaging Oppurtunities and Top Benefits">
                                <img src='images/samples/100x100/image_06.jpg' alt='img'>
                            </a>
                            <div class="post_content">
                                <h5>
                                    <a href="indexb878.html?page=post" title="Engaging Oppurtunities and Top Benefits">Engaging Oppurtunities and Top Benefits</a>
                                </h5>
                                <p>Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.</p>
                            </div>
                        </li>
                        <li class="post">
                            <a href="index4e1c.html?page=post_small_image" title="Advertising With PressRoom">
                                <img src='images/samples/100x100/image_12.jpg' alt='img'>
                            </a>
                            <div class="post_content">
                                <h5>
                                    <a href="index4e1c.html?page=post_small_image" title="Advertising With PressRoom">Advertising With PressRoom</a>
                                </h5>
                                <p>Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.</p>
                            </div>
                        </li>
                        <li class="post">
                            <a href="index4e1c.html?page=post_small_image" title="Press Office, Licensees and Employment">
                                <img src='images/samples/100x100/image_02.jpg' alt='img'>
                            </a>
                            <div class="post_content">
                                <h5>
                                    <a href="index4e1c.html?page=post_small_image" title="Press Office, Licensees and Employment">Press Office, Licensees and Employment</a>
                                </h5>
                                <p>Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.</p>
                            </div>
                        </li>
