                        ...
                        <ul class="blog horizontal_carousel autoplay-1 scroll-1 visible-3 navigation-1 easing-easeInOutQuint duration-750">
                            ...
                            <li class="post">
                                <a href="#" title="New Painkiller Rekindles Addiction Concerns">
                                    <img class="post_inner_top" src='{{ asset('storage/'.$post1->file_url) }}' alt='img'>
                                </a>
                                <h5><a href="#" title="New Painkiller Rekindles Addiction Concerns">{{ $post1->title }}</a></h5>
                                <ul class="post_details simple">
                                    <li class="category"><a href="#" title="HEALTH">{{ $post1->category->name }}</a></li>
                                    <li class="date">
            ...
            <div class="row page_margin_top">
                <div class="column column_2_3">
                        ...
                        <div class="post single">
                            ...
                            <div class="post_content page_margin_top_section clearfix">
                                ...
                                <div class="author_box animated_element">
                                    <div class="author">
                                        <a title="Anna Shubina" href="index27b5.html?page=author" class="thumb thumb_user">
                                            <img class="user_image" alt="img" src="{{asset('storage/files/user.jpg')}}">
                                        </a>
                                        <div class="details">
                                            <h5><a title="Anna Shubina" href="index27b5.html?page=author">{{$post->user->name}}</a></h5>
                                            <h6>EDITOR</h6>
                    ...
                    <div class="row page_margin_top_section">
                        ...
                        <form class="comment_form margin_top_15" id="comment_form" method="post" action="https://quanticalabs.com/Pressroom/Template/?page=post">
                            ...
                            <ul class="blog rating page_margin_top clearfix">
                                ...
                                <li class="post">
                                    <div class="post_content">
                                        ...
                                        <h5><a href="index4b64.html?page=post_quote" title="Seeking the Right Chemistry, Drug Makers Hunt for Mergers">Seeking the Right Chemistry, Drug Makers Hunt for Mergers</a></h5>
                                        <ul class="post_details simple">
                                ...
                                <li class="post">
                                    <div class="post_content">
                                        ...
                                        <h5><a href="index4e1c.html?page=post_small_image" title="Study Linking Illnes and Salt Leaves Researchers Doubtful">Study Linking Illnes and Salt Leaves Researchers Doubtful</a></h5>
                                        <ul class="post_details simple">
                            ...
                            <ul class="blog rating page_margin_top clearfix">
                                ...
                                <li class="post">
                                    <div class="post_content">
                                        ...
                                        <h5><a href="index205e.html?page=post_quote_2" title="Study Linking Illnes and Salt Leaves Researchers Doubtful">Study Linking Illnes and Salt Leaves Researchers Doubtful</a></h5>
                                        <ul class="post_details simple">
                                            <li class="category"><a href="indexdd47.html?page=category&amp;cat=science" title="SCIENCE">SCIENCE</a></li>
                                        </ul>
                                    </div>
                    ...
                    <div class="vertical_carousel_container clearfix">
                        <ul class="blog small vertical_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
                            ...
                            <li class="post">
                                ...
                                <div class="post_content">
                                    <h5>
                                        <a href="index224d.html?page=post_soundcloud" title="Nuclear Fusion Closer to Becoming a Reality">Nuclear Fusion Closer to Becoming a Reality</a>
                                    </h5>
                                    <ul class="post_details simple">
                                        <li class="category"><a href="indexdd47.html?page=category&amp;cat=science" title="SCIENCE">SCIENCE</a></li>
                                        <li class="date">
